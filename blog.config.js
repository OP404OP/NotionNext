...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2024, // e.gif leave this empty, current year will be used.
  ...
  GREETING_WORDS:
    ...
    'Hi，欢迎来到PK公告牌, PK公告牌，不专注互联网资源分享',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'PK公告牌', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不专注互联网资源分享，好资源，好知识记录下来。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'PK公告牌, PK, 公告牌, 资源分享, 福利资源, 绿色软件, 破解资源, Notion, FlowUs, 科技站点, 看新闻, 精品资源, Windows系统, 免费软件, 便携软件, 软件博客, 技术教程, 电脑软件, 423down, zd423, ', // 网站关键词 英文逗号隔开
